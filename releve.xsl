        ...
        <html>
            <body>
                ...
                <table width="90%" border="1">
                    ...
                    <tr>
                        <td colspan="2"> Total des operations debit:<xsl:value-of select="sum(//operation[type='debit']/montant)"/></td>
                        <td colspan="2"> Total des operations credit:<xsl:value-of select="sum(//operation[type='credit']/montant)"/></td>
                    </tr>
                </table>
            </body>
        </html>
